  ...
  return (
    <main className="">
      ...
      <div className="sidebar">
        ...
        <div>
          <div style={{ background: "black", width: "18%", height: "100%", position: "fixed", top: "18%", textAlign:"end",}}>
      ...
      <div className='head' style={{ position: "fixed", top: "20%", left: "85%", background: "", width: "15%", height: "15%", borderRadius: "5%" }}>
